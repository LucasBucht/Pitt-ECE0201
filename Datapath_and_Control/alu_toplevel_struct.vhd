...
ARCHITECTURE struct OF ALU_TopLevel IS
   ...
   SIGNAL ANDSignal       : std_logic_vector(7 DOWNTO 0);
   SIGNAL AdderSignal     : std_logic_vector(7 DOWNTO 0);
   SIGNAL InversionSignal : std_logic_vector(7 DOWNTO 0);
   SIGNAL ORSignal        : std_logic_vector(7 DOWNTO 0);
